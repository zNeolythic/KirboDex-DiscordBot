...
class Balls(commands.GroupCog, group_name=settings.players_group_cog_name):
    """
    View and manage your kirbos collection.
    """
    ...
    async def completion(
        ...
        """
        Show your current completion of the KirboDex.
    ...
    async def info(
        ...
        """
        Display info from a specific kirbo.
    ...
    async def last(self, interaction: discord.Interaction, user: discord.User | None = None):
        """
        Display info of your or another users last caught kirbo.
    ...
    async def count(
        ...
        """
        Count how many kirbos you have.
