...
class Player(commands.GroupCog):
    ...
    async def donation_policy(
        ...
        """
        Change how you want to receive donations from /kirbos give
    ...
    async def export(self, interaction: discord.Interaction, type: str):
        ...
        if zip_file.tell() > 25_000_000:
            await interaction.followup.send(
                ...
                "\nPlease create a ticket in #support in the KirboDex Support Server for more information. https://discord.gg/vUzHXxnuRs",
                ephemeral=True,
            )
            return
        ...
        try:
            ...
            await interaction.followup.send(
                "Your player data has been sent via DMs."
                "**__Use Microsoft Excel to open the CSVs.__** \n", 
                ephemeral=True,
            )
